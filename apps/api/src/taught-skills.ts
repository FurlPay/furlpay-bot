...
import type { Actor, MessageBlock, TaughtSkill } from "@furlpay-bot/contracts";
import {
  ACTIVE_RUN_STATUSES,
...
import { IsolationError, type PrismaClient, type ThreadEvents } from "@furlpay-bot/db";
...
async function ensureGraphicalComputer(
  deps: TaughtSkillsDeps,
  actor: Actor,
  bot: Awaited<ReturnType<ReturnType<typeof import("@furlpay-bot/db").createRepos>["getBot"]>>,
) {
