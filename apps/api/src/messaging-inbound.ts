import type { JobPublisher, MessagingInboundMessage } from "@furlpay-bot/adapter-kit";
import { messagingDeliverJob, runContinueJob } from "@furlpay-bot/adapter-kit";
import type { MessageBlock } from "@furlpay-bot/contracts";
import { parseMessagingCommand, sanitizeMessagingLabel } from "@furlpay-bot/core";
import type {
      ...
      data: [
        {
          ...
          body: "Hi. This line hosts FurlPay Bot personal agents. Some people in this group haven't messaged it yet; send any message to this line first if you want your own agent here.",
        },
      ],
      skipDuplicates: true,
    });
    ...
    data: [
      {
        ...
        body: `"${name}" was linked to your FurlPay Bot agent. Reply YES to let your agent join the conversation there, or NO to stay out.`,
      },
    ],
    skipDuplicates: true,
  });
