import { type JobPublisher, runContinueJob } from "@furlpay-bot/adapter-kit";
import { toComputerRef } from "@furlpay-bot/adapters";
import {
  type Actor,
  GROUP_MEMBER_MIN,
  type GroupMember,
...
export async function stopThreadRuns(
  deps: {
    prisma: PrismaClient;
    sandbox: import("@furlpay-bot/adapter-kit").SandboxProvider;
  },
  actor: Actor,
  target: ThreadTarget,
) {
