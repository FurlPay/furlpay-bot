...
import type { ThreadMessage, ThreadSnapshot } from "@furlpay-bot/contracts";
import { isSecretAskBlock, narrateTool, speechFromBlocks, spokenDecision } from "@furlpay-bot/core";
  ...
  return (
    <div className="absolute inset-0 z-40 grid place-items-center bg-[rgba(4,4,5,.82)] px-5">
      <div
        ...
        className="w-full max-w-[420px] rounded-[24px] border border-[var(--fp-scroll)] bg-[var(--fp-surface)] p-6 text-center shadow-[0_30px_80px_rgba(0,0,0,.55)]"
      >
        <div className="text-[13px] uppercase tracking-[0.12em] text-[var(--fp-muted-2)]">
          <Trans>Call</Trans>
        </div>
        <div className="mt-2 text-[22px] font-medium text-[var(--fp-ink-strong)]">{botName}</div>
        <div className="mt-5 text-[15px] text-[var(--fp-soft)]">
          {phase === "listening" ? (
        ...
        <p className="mt-3 min-h-[3.2em] text-[14.5px] leading-[1.5] text-[var(--fp-muted)]">
        ...
        <div className="mt-6 flex justify-center gap-3">
          <button
            type="button"
            onClick={interrupt}
            className="rounded-full border border-[var(--fp-scroll)] px-4 py-2 text-[14px] text-[var(--fp-soft)]"
          >
          ...
          <button
            type="button"
            onClick={hangUp}
            className="rounded-full bg-[var(--fp-danger-strong)] px-4 py-2 text-[14px] font-medium text-white"
          >
            <Trans>Hang up</Trans>
          </button>
        </div>
        <p className="mt-4 text-[12px] text-[var(--fp-muted-2)]">
