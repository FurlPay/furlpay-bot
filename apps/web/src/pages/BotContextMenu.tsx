...
import type { Bot, BotSection } from "@furlpay-bot/contracts";
  ...
  return (
    <div className="fixed inset-0 z-40">
      ...
      <div
        ...
        className="fixed w-[264px] rounded-[18px] border border-[var(--fp-elevated)] bg-[var(--fp-surface-2)] p-2 shadow-[0_24px_60px_rgba(0,0,0,.62)]"
      ...
      >
        ...
        />
        <div className="my-1 border-t border-[var(--fp-elevated)]" />
      ...
      {sectionMenuOpen ? (
        <div
          ...
          className="fixed max-h-[min(420px,calc(100vh-16px))] w-[264px] overflow-y-auto rounded-[18px] border border-[var(--fp-elevated)] bg-[var(--fp-surface-2)] p-2 shadow-[0_24px_60px_rgba(0,0,0,.62)]"
...
function MenuItem({
  ...
  return (
    <button
      ...
      className={`flex w-full items-center gap-3 rounded-[11px] px-3 py-2.5 text-start text-[15px] outline-none hover:bg-[var(--fp-scroll)] focus-visible:bg-[var(--fp-scroll)] ${
        tone === "danger" ? "text-[var(--fp-danger)]" : "text-[var(--fp-ink)]"
      }`}
      onClick={onSelect}
    >
