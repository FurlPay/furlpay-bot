...
export function McpOAuthCallbackPage() {
  ...
  return (
    <div className="grid min-h-screen place-items-center bg-[var(--fp-page)] p-6 text-center">
      <div>
        <div className="text-lg text-[var(--fp-ink-strong)]">
          {error ? (
        ...
        {showReturn ? (
          ...
          >
            <Trans>Return to FurlPay Bot</Trans>
          </button>
        ) : (
