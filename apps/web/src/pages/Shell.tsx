...
function collapsedSidebarSectionsStorageKey(userId: string | null | undefined): string | null {
  ...
  return `furlpay-bot:collapsed-sidebar-sections:${userId}`;
}
...
export function ShellPage() {
  ...
  const shell = (
    <div
      ...
      className="relative flex h-full min-w-0 overflow-hidden bg-[var(--fp-page)] text-[var(--fp-body)]"
    >
      ...
      <aside
        className={`absolute inset-y-0 start-0 z-40 flex w-[calc(100%-48px)] max-w-[316px] shrink-0 flex-col border-e border-[var(--fp-hairline)] bg-[var(--fp-sidebar)] transition-transform md:static md:z-auto md:w-[316px] md:translate-x-0 ${
      ...
      >
        <div className="app-drag flex items-center justify-between px-[18px] pb-3 pt-4">
          ...
          <div className="relative flex items-center gap-2.5">
            <button
              ...
              className={`app-no-drag flex h-7 w-7 items-center justify-center rounded-full ${
                activityMode
                  ...
                  : "text-[var(--fp-faint)] hover:text-[var(--fp-soft)]"
              }`}
            >
              <Bell
                size={15}
            ...
            <button
              ...
              className="app-no-drag text-[21px] text-[var(--fp-faint)] hover:text-[var(--fp-soft)]"
              title={t`Create`}
            >
              +
            </button>
            {createMenuOpen ? (
              <div className="app-no-drag absolute end-0 top-full z-20 mt-2 min-w-[160px] rounded-xl border border-[var(--fp-border)] bg-[var(--fp-surface)] py-1 shadow-lg">
                <button
                  type="button"
                  className="block w-full px-3.5 py-2 text-start text-[14px] text-[var(--fp-ink)] hover:bg-[var(--fp-surface-2)]"
                  onClick={() => {
                ...
                <div className="my-1 border-t border-[var(--fp-border)]" />
                <button
                  type="button"
                  className="flex w-full items-center gap-2 px-3.5 py-2 text-start text-[14px] text-[var(--fp-ink)] hover:bg-[var(--fp-surface-2)]"
                  onClick={() => {
                    setCreateMenuOpen(false);
        ...
        <div className="mx-3.5 mb-3 flex items-center gap-2.5 rounded-xl border border-[var(--fp-hairline-strong)] bg-[var(--fp-surface)] px-3 py-2 text-[14px] text-[var(--fp-body)]">
          <span aria-hidden="true">⌕</span>
          <input
            value={query}
            onChange={(e) => setQuery(e.target.value)}
            placeholder={t`Search`}
            className="w-full bg-transparent text-[var(--fp-ink)] outline-none placeholder:text-[var(--fp-body)]"
          />
        </div>
        <div className="rk-scroll flex flex-1 flex-col gap-0.5 overflow-y-auto px-2.5 pb-2.5">
                  ...
                  <div key={group.key} data-sidebar-group={group.key}>
                    {group.title ? (
                      <div className="pt-2">
                        <button
                          type="button"
                          className="flex w-full items-center justify-between gap-2 rounded-lg px-2.5 py-1.5 text-[12.5px] font-medium text-[var(--fp-muted-2)] hover:bg-[var(--fp-surface-2)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-[#8B5CF6]"
                          onClick={() => {
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="flex items-baseline justify-between gap-2">
                              <span
                                ...
                                className={`truncate text-[15px] text-[var(--fp-ink)] ${
                              ...
                              <span className="flex shrink-0 items-center gap-1.5 text-[12.5px] text-[var(--fp-muted-2)]">
                            ...
                            {item.kind === "bot" && item.chat.title ? (
                              <>
                                ...
                                {item.chat.preview ? (
                                  <div
                                    dir="auto"
                                    className="truncate text-[12.5px] text-[var(--fp-muted-2)]"
                                  >
                                    {item.chat.preview}
                                  </div>
                                ) : null}
          ...
          {archivedBots.length + archivedGroups.length > 0 && !showSpaceSearch ? (
            <div className="mt-2 border-t border-[var(--fp-hairline-strong)] pt-2">
              <button
                type="button"
                aria-expanded={archivedOpen}
                onClick={() => setArchivedOpen((open) => !open)}
                className="flex w-full items-center justify-between rounded-lg px-2.5 py-2 text-[13.5px] text-[var(--fp-muted)] hover:bg-[var(--fp-page)]"
              >
                <span>
                ...
                <>
                  {archivedBots.map((bot) => (
                    <div key={bot.id} className="flex items-center gap-2 rounded-lg px-2.5 py-2">
                      ...
                      />
                      <span
                        className="min-w-0 flex-1 truncate text-[14px] text-[var(--fp-soft)]"
                        dir="auto"
                      >
                        {bot.name}
                      </span>
                      <button
                        ...
                        className="text-[12.5px] text-[var(--fp-soft)] hover:text-[var(--fp-ink)]"
                      >
                        <Trans>Restore</Trans>
                      </button>
                      <button
                        ...
                        className="text-[12.5px] text-[var(--fp-danger)]"
                      >
                        <Trans>Delete</Trans>
                      </button>
                    </div>
        ...
        <button
          ...
          className="mx-3 mb-1 flex items-center gap-3 rounded-[11px] px-2.5 py-2 hover:bg-[var(--fp-page)]"
        >
          <span className="grid h-[30px] w-[30px] place-items-center rounded-full bg-[var(--fp-hairline)] text-[var(--fp-soft)]">
            <Puzzle size={15} strokeWidth={1.7} />
          </span>
          <span className="text-[14.5px] text-[var(--fp-body)]">
            <Trans>Integrations</Trans>
          </span>
        </button>
        <div className="relative">
          {menuOpen ? (
            <div className="absolute bottom-14 inset-x-3 rounded-2xl border border-[var(--fp-scroll)] bg-[var(--fp-surface-2)] p-2 shadow-[0_22px_50px_rgba(0,0,0,.55)]">
              <button
                type="button"
                ...
                className="flex w-full items-center gap-3 rounded-[11px] px-3 py-2.5 hover:bg-[var(--fp-hairline-strong)]"
              >
                <span className="text-[var(--fp-muted)]">⚙</span>
                <span className="flex-1 text-start text-[14.5px] text-[var(--fp-ink)]">
              ...
              <button
                ...
                className="flex w-full items-center gap-3 rounded-[11px] px-3 py-2.5 hover:bg-[var(--fp-hairline-strong)]"
              >
                <Cpu size={16} strokeWidth={1.7} className="text-[var(--fp-muted)]" />
                <span className="flex-1 text-start text-[14.5px] text-[var(--fp-ink)]">
                  <Trans>Models</Trans>
                </span>
              </button>
              ...
              <button
                ...
                className="flex w-full items-center gap-3 rounded-[11px] px-3 py-2.5 hover:bg-[var(--fp-hairline-strong)]"
              >
                <Volume2 size={16} strokeWidth={1.7} className="text-[var(--fp-muted)]" />
                <span className="flex-1 text-start text-[14.5px] text-[var(--fp-ink)]">
                  <Trans>Voice</Trans>
                </span>
              </button>
              ...
              >
                <Gauge size={16} strokeWidth={1.7} className="text-[var(--fp-muted)]" />
                <span className="flex-1 text-start text-[14.5px] text-[var(--fp-ink)]">
                  <Trans>Usage</Trans>
                </span>
              </button>
              {usage ? (
                <p className="px-3 pb-2 text-[12.5px] text-[var(--fp-muted)]">
                  <Trans>
              ...
              <button
                ...
                className="flex w-full items-center gap-3 rounded-[11px] px-3 py-2.5 hover:bg-[var(--fp-hairline-strong)]"
              >
                <LogOut size={16} strokeWidth={1.7} className="text-[var(--fp-muted)]" />
                <span className="text-[14.5px] text-[var(--fp-ink)]">
                  <Trans>Log out</Trans>
                </span>
              </button>
            </div>
          ...
          >
            <span className="grid h-8 w-8 place-items-center rounded-full bg-[var(--fp-hairline-strong)] text-[12px] text-[var(--fp-soft)]">
              {initials}
            </span>
            <span className="text-[14.5px] text-[var(--fp-body)]">{userName}</span>
          </button>
        </div>
      </aside>
      ...
      <main
        ...
        className="flex min-w-0 flex-1 flex-col bg-[var(--fp-main)]"
      >
        <div className="app-drag flex items-center justify-between border-b border-[var(--fp-surface)] px-3 py-[17px] md:px-[22px]">
          <div className="flex min-w-0 items-center gap-2">
            <button
              type="button"
              aria-label={t`Open navigation`}
              onClick={() => setMobileSidebarOpen(true)}
              className="app-no-drag grid h-8 w-8 shrink-0 place-items-center rounded-lg text-[var(--fp-soft)] hover:bg-[var(--fp-elevated)] md:hidden"
            >
            ...
            >
              ...
              <span className="min-w-0">
                <span
                  className="block truncate text-[16px] font-medium text-[var(--fp-ink)]"
                  dir="auto"
                >
                  {inGroup
          ...
          <div className="flex items-center gap-1">
            {!inGroup && active ? (
              <button
                ...
                className="app-no-drag grid h-[30px] w-[34px] place-items-center rounded-[9px] hover:bg-[var(--fp-elevated)]"
                style={{ background: callOpen ? "var(--fp-elevated)" : "transparent" }}
              >
                <Phone size={16} strokeWidth={1.6} className="text-[var(--fp-soft)]" />
              </button>
            ) : null}
            {!inGroup ? (
              <button
                ...
                className="app-no-drag grid h-[30px] w-[34px] place-items-center rounded-[9px] hover:bg-[var(--fp-elevated)]"
                style={{ background: panel ? "var(--fp-elevated)" : "transparent" }}
              >
                <Monitor size={18} strokeWidth={1.6} className="text-[var(--fp-soft)]" />
              </button>
            ) : null}
          </div>
        </div>
        ...
        />
        {recordingSkill ? (
          <div className="px-6 pb-2 text-center text-[13px] text-[var(--fp-danger)]">
      ...
      <aside
        ...
        className={`absolute inset-y-0 end-0 z-20 flex min-h-0 shrink-0 flex-col overflow-hidden bg-[var(--fp-panel)] transition-[width] duration-150 ease-out md:relative ${
          panel && (active || activeGroup)
            ? "w-full max-w-[384px] border-s border-[var(--fp-surface)] md:w-[384px] md:max-w-none"
          ...
          <div className="rk-scroll h-full w-full overflow-y-auto px-5 py-[17px] md:w-[384px]">
            ...
            panel !== "group-settings" ? (
              <div className="mb-4 flex items-center justify-between">
                <span className="text-[13.5px] text-[var(--fp-muted)]">
                  {panel === "settings" ? (
                    <Trans>Settings</Trans>
                  ) : active ? (
            ...
            {panel === "computer" && active ? (
              <div>
                <div
                  ...
                  className="group relative aspect-[16/10] overflow-hidden rounded-[14px] bg-[var(--fp-panel)]"
                >
                  {computerOpen ? (
                    <div className="grid h-full place-items-center text-sm text-[var(--fp-muted-2)]">
                      <Trans>Open in full window</Trans>
                    </div>
                  ) : computer?.kind === "desktop" ? (
                    <div className="grid h-full place-items-center px-6 text-center text-sm text-[var(--fp-muted-2)]">
                      <Trans>
                  ...
                  >
                    <span className="inline-flex items-center gap-2 rounded-full bg-[rgba(12,12,14,.82)] px-3.5 py-2 text-[14px] text-[var(--fp-ink-strong)] shadow-[0_8px_24px_rgba(0,0,0,.45)]">
                      <Maximize2 size={15} strokeWidth={1.9} aria-hidden />
                      <Trans>Open</Trans>
                    </span>
                  </button>
                </div>
                <p className="mt-2 truncate text-[13.5px] text-[var(--fp-muted)]" dir="auto">
      ...
      {booting ? (
        <div className="absolute inset-0 z-30 flex flex-col items-center justify-center gap-[22px] bg-[rgba(4,4,5,.96)]">
          <div className="text-[19px] font-medium text-[var(--fp-ink-strong)]">
            <Trans>Booting up {active?.name}’s computer</Trans>
          </div>
          <div className="h-[5px] w-[min(420px,70%)] overflow-hidden rounded-full bg-[var(--fp-hairline-strong)]">
            <div className="h-full w-2/3 rounded-full bg-[var(--fp-cream)]" />
          </div>
        </div>
      ) : computerOpen && active ? (
        <div className="absolute inset-0 z-30 flex flex-col bg-[var(--fp-page)]">
          <div
            data-testid="computer-chrome"
            className="flex items-center justify-between gap-4 border-b border-[var(--fp-hairline)] px-[18px] py-3.5"
          >
            <div className="flex min-w-0 flex-1 items-center gap-3">
              ...
              {recordingSkill ? (
                ...
                <span
                  className="truncate text-[15.5px] font-medium text-[var(--fp-ink)]"
                  dir="auto"
                >
                  {computerLabel(computer?.mode, active.name)}
                </span>
              ...
              {!recordingSkill && hasControl ? (
                <span className="rounded-full bg-[rgba(48,162,75,.14)] px-[11px] py-1 text-[13px] text-[var(--fp-success-soft)]">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                type="button"
                className="text-[16px] text-[var(--fp-muted)] hover:text-[var(--fp-ink)]"
          ...
          {sendError ? (
            <div
              role="alert"
              className="border-b border-[#5A2A2A] bg-[#2A1717] px-[18px] py-2 text-[13px] text-[var(--fp-danger-soft)]"
            >
              {sendError}
            </div>
          ) : null}
          <div className="relative min-h-0 flex-1 bg-[var(--fp-panel)]">
            {computer?.kind === "desktop" ? (
              <div className="grid h-full place-items-center px-8 text-center text-sm text-[var(--fp-muted-2)]">
                <Trans>
  ...
  return (
    <div className="relative flex min-h-0 flex-1">
      ...
      >
        {olderCursor != null ? (
          <button
            ...
            className="self-center rounded-lg px-3 py-1.5 text-[13px] text-[var(--fp-muted)] hover:bg-[var(--fp-surface-2)] hover:text-[var(--fp-soft)] disabled:opacity-50"
          >
            ...
            >
              ...
              {!peerReceipt && message.thumbsUp ? (
                <button
                  ...
                  className={`mt-1 rounded-full border border-[var(--fp-scroll)] bg-[var(--fp-surface-2)] px-2 py-0.5 text-xs ${
      ...
      <button
        ...
        className={`absolute bottom-4 left-1/2 z-20 grid h-9 w-9 -translate-x-1/2 place-items-center rounded-full border border-[var(--fp-scroll)] bg-[var(--fp-surface-2)]/95 text-[var(--fp-soft)] shadow-[0_8px_24px_rgba(0,0,0,.45)] backdrop-blur transition-[opacity,transform,background-color] duration-200 ease-[cubic-bezier(.22,1,.36,1)] hover:bg-[var(--fp-border)] motion-reduce:transition-none ${
    ...
    >
      {sendError || dictationError || runError ? (
        <div
          ...
          className="mb-3 flex items-center gap-2 rounded-[14px] border border-[#5A2A2A] bg-[#2A1717] px-4 py-2 text-[13px] text-[var(--fp-danger-soft)]"
        >
          ...
          <button
            ...
            className="shrink-0 text-[var(--fp-danger-soft)] hover:text-[var(--fp-ink)]"
          >
      ...
      {replyTarget ? (
        <div
          ...
          className="mb-2 flex items-center gap-2 rounded-full border border-[var(--fp-border)] bg-[var(--fp-hairline)] px-3 py-1.5 text-[13px] text-[var(--fp-soft)]"
        >
          <span className="min-w-0 flex-1 truncate text-[var(--fp-muted)]">{t`Replying to ${replyName}`}</span>
          <button
            type="button"
            aria-label={t`Cancel reply`}
            onClick={onClearReply}
            className="shrink-0 text-[var(--fp-muted)] hover:text-[var(--fp-ink)]"
          >
            <X size={13} strokeWidth={2} />
          </button>
        </div>
      ...
      {pendingAttachments.length ? (
        <div className="mb-3 flex flex-wrap gap-2">
          {pendingAttachments.map((attachment) => (
            <div
              key={attachment.id}
              className="flex items-center gap-2 rounded-full border border-[var(--fp-border)] bg-[var(--fp-hairline)] px-3 py-1.5 text-[13px] text-[var(--fp-soft)]"
            >
              ...
              <button
                ...
                className="text-[var(--fp-muted)] hover:text-[var(--fp-ink)]"
              >
                <X size={13} strokeWidth={2} />
              </button>
            </div>
      ...
      {mentionPickerOpen ? (
        <div
          ...
          className="mb-2 overflow-hidden rounded-[14px] border border-[var(--fp-border)] bg-[var(--fp-hairline)]"
        >
          {mentionOptions.map((mention, index) => {
            ...
            return (
              <button
                ...
                className={`flex w-full items-start gap-3 px-4 py-2.5 text-start hover:bg-[var(--fp-elevated)] ${
                  highlighted ? "bg-[var(--fp-elevated)]" : ""
                }`}
              >
                <MentionOptionIcon mention={mention} />
                <span className="min-w-0">
                  <span dir="auto" className="block text-[14px] text-[var(--fp-ink)]">
                    @{mention.name}
                  </span>
                  {mention.subtitle ? (
                    <span
                      dir="auto"
                      className="block truncate text-[12.5px] text-[var(--fp-muted)]"
                    >
                      {mention.subtitle}
                    </span>
                  ) : null}
        ...
        >
          {slashSkillOptions.map((skill) => (
            <button
              ...
              className="flex w-full items-start gap-3 px-4 py-2.5 text-start hover:bg-[var(--fp-elevated)]"
            >
              <Box size={16} strokeWidth={1.7} className="mt-0.5 shrink-0 text-[var(--fp-muted)]" />
              <span className="min-w-0">
                <span dir="auto" className="block text-[14px] text-[var(--fp-ink)]">
                  {skill.name}
                </span>
                <span dir="auto" className="block truncate text-[12.5px] text-[var(--fp-muted)]">
          ...
          {slashActionOptions.map((action) => {
            ...
            return (
              <button
                ...
                className="flex w-full items-center gap-3 px-4 py-2.5 text-start hover:bg-[var(--fp-elevated)]"
              >
                <Settings size={16} strokeWidth={1.7} className="shrink-0 text-[var(--fp-muted)]" />
                <span className="text-[14px] text-[var(--fp-ink)]">{label}</span>
              </button>
            );
          })}
        </div>
      ...
      <div
        ...
        className="flex items-center gap-3.5 rounded-full border border-[var(--fp-hairline-strong)] bg-[var(--fp-page)] py-[9px] pe-2.5 ps-3"
      >
        <input
          ref={fileInputRef}
          type="file"
        ...
        <button
          ...
          className="grid h-[34px] w-[34px] shrink-0 place-items-center rounded-full border border-[var(--fp-border)] text-[var(--fp-soft)] disabled:opacity-40"
        >
        ...
        <button
          ...
          className={`grid h-[34px] w-[34px] shrink-0 place-items-center rounded-full border ${
            dictating
              ? "border-[var(--fp-success-soft)] bg-[rgba(48,162,75,.16)] text-[var(--fp-success-soft)]"
              : "border-[var(--fp-border)] text-[var(--fp-soft)]"
          }`}
        ...
        <div className="flex min-w-0 flex-1 flex-wrap items-end gap-1.5">
          {selectedSkill ? (
            <span
              ...
              className="inline-flex max-w-full items-center gap-1.5 rounded-full bg-[var(--fp-elevated)] px-2.5 py-1 text-[13px] text-[var(--fp-ink)]"
            >
          ...
          <textarea
            ...
            dir="auto"
            rows={1}
            className="max-h-32 min-h-[24px] min-w-[8rem] flex-1 resize-none overflow-y-auto bg-transparent py-0.5 text-[15.5px] leading-6 text-[var(--fp-ink)] outline-none placeholder:text-[var(--fp-body)] disabled:opacity-40"
          />
        </div>
        {running ? (
          <>
            <button
              ...
              onClick={send}
              className="grid h-10 w-10 place-items-center rounded-full bg-[var(--fp-cream)] text-[var(--fp-cream-ink)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#A6A6AD] disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={sending}
              onClick={() => void onStop()}
              className="grid h-10 w-10 place-items-center rounded-full border border-[var(--fp-scroll)] text-[var(--fp-soft)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#A6A6AD] disabled:opacity-50"
            >
          ...
          <button
            ...
            disabled={sending || !canSend || disabled}
            onClick={send}
            className="grid h-9 w-9 place-items-center rounded-full bg-[var(--fp-cream)] text-[var(--fp-cream-ink)] disabled:opacity-50"
          >
            <ArrowUp size={18} strokeWidth={2} />
          </button>
        )}
...
function MentionOptionIcon({ mention }: { mention: ComposerMention }) {
  if (mention.kind === "routine") {
    return <Clock size={16} strokeWidth={1.7} className="mt-0.5 shrink-0 text-[var(--fp-muted)]" />;
  }
  if (mention.kind === "connector") {
    return (
      <Puzzle size={16} strokeWidth={1.7} className="mt-0.5 shrink-0 text-[var(--fp-muted)]" />
    );
  }
  if (mention.kind === "group") {
    return (
      <span className="mt-0.5 grid h-4 w-4 shrink-0 place-items-center rounded-full bg-[var(--fp-scroll)] text-[9px] text-[var(--fp-soft)]">
        G
      </span>
    );
  }
...
function MentionChipIcon({ mention }: { mention: ComposerMention }) {
  ...
  if (mention.kind === "group" || mention.kind === "everyone") {
    return (
      <span className="grid h-4 w-4 shrink-0 place-items-center rounded-full bg-[var(--fp-scroll)] text-[9px] text-[var(--fp-soft)]">
  ...
  return (
    <MessageHoverMetadata createdAt={message.createdAt}>
      <div
        ...
        className="flex items-center gap-0.5 rounded-full bg-[var(--fp-elevated)] p-0.5 shadow-[0_1px_4px_rgba(0,0,0,0.45)]"
      >
        <button
          type="button"
          aria-label={t`Reply`}
          onClick={() => onReply(message)}
          className="grid h-7 w-7 place-items-center rounded-full text-[var(--fp-soft)] hover:bg-[var(--fp-scroll)] hover:text-[var(--fp-ink)]"
        >
        ...
        {canReactToThreadMessage(message) ? (
          <button
            ...
            onClick={() => void onReact(message)}
            className={`grid h-7 w-7 place-items-center rounded-full hover:bg-[var(--fp-scroll)] hover:text-[var(--fp-ink)] ${
              message.thumbsUp ? "text-[#E9C46A]" : "text-[var(--fp-soft)]"
            }`}
          >
...
const MessageView = memo(function MessageView({
  ...
  const messageContext = (
    <>
      {speakerName ? (
        <div className="mb-1 text-[12.5px] font-medium text-[var(--fp-muted)]" dir="auto">
          {speakerName}
        </div>
      ) : null}
      {parentJumpId ? (
        <button
          ...
          className="mb-2 block max-w-[74%] truncate rounded-[14px] border border-[var(--fp-border)] bg-[var(--fp-page)] px-3 py-2 text-start text-[12.5px] text-[var(--fp-muted)] hover:border-[var(--fp-elevated)] hover:text-[var(--fp-soft)]"
          dir="auto"
        >
    ...
    return (
      <>
        ...
        <div className="flex justify-start">
          <div
            className="max-w-[74%] space-y-2.5 rounded-[20px] bg-[var(--fp-surface-2)] px-[18px] py-3 text-[15.5px] leading-[1.5] text-[var(--fp-body)]"
            dir="auto"
          >
            ...
            {!isLive && voiceReady && message.blocks.some((block) => block.kind === "text") ? (
              <button
                ...
                onClick={onSpeak}
                className="text-[12px] text-[var(--fp-muted)] hover:text-[var(--fp-ink)]"
              >
      ...
      {message.blocks.map((block, i) => {
        if (block.kind === "handoff") {
          ...
          return (
            <div
              key={i}
              className="flex items-center justify-center gap-2 py-1 text-[13.5px] text-[var(--fp-muted)]"
            >
              <span>
                ↪ {to} ← {from}
              </span>
        ...
        if (block.kind === "progress") {
          return (
            <div key={i} className="flex justify-start">
              <div
                className="max-w-[74%] rounded-[20px] bg-[var(--fp-surface-2)] px-[18px] py-3 text-[15.5px] leading-[1.5] text-[var(--fp-body)]"
                dir="auto"
              >
        ...
        if (block.kind === "steps") {
          return (
            <div key={i} className="flex justify-start">
              <div
                className="max-w-[74%] space-y-1.5 rounded-[20px] bg-[var(--fp-surface-2)] px-[18px] py-3"
                dir="ltr"
              >
                <ToolActivityDisclosure
                  live={isLive}
        ...
        if (block.kind === "subagent") {
          ...
          return (
            <div
              key={i}
              className="w-[min(420px,90%)] rounded-[18px] border border-[var(--fp-hairline-strong)] bg-[var(--fp-hairline)] px-[18px] py-4"
            >
              <div className="flex items-center justify-between gap-3">
                <span className="text-[15px] font-medium text-[var(--fp-ink)]" dir="auto">
                  {block.name}
                </span>
                <span
              ...
              <div className="mt-2 text-[13.5px] text-[var(--fp-muted)]">{block.task}</div>
              {block.progress || block.result ? (
                <div className="mt-2.5 text-[14.5px] leading-[1.5] text-[var(--fp-soft)]">
        ...
        if (block.kind === "child_bot") {
          ...
          return (
            <button
              ...
              className="w-[min(340px,90%)] rounded-[18px] border border-[var(--fp-hairline-strong)] bg-[var(--fp-hairline)] px-[18px] py-4 text-start disabled:opacity-60"
            >
              ...
              <div className="mt-2 text-[14.5px] leading-[1.5] text-[var(--fp-soft)]" dir="auto">
                {removed
                  ? block.status === "archived"
        ...
        if (block.kind === "text" && message.role === "user") {
          return (
            <div key={i} className="flex justify-end">
              <div
                className="max-w-[70%] whitespace-pre-wrap rounded-[20px] bg-[var(--fp-cream)] px-[18px] py-3 text-[15.5px] leading-[1.45] text-[var(--fp-cream-ink)]"
                dir="auto"
              >
                {block.text}
              </div>
              ...
              >
                ...
                {voiceReady ? (
                  <button
                    ...
                    aria-label={speaking ? t`Stop speaking` : t`Speak this reply`}
                    onClick={onSpeak}
                    className="mt-2 text-[12px] text-[var(--fp-muted)] hover:text-[var(--fp-ink)]"
                  >
                    {speaking ? <Trans>Stop</Trans> : <Trans>Speak</Trans>}
                  </button>
                ) : null}
        ...
        if (block.kind === "card") {
          return (
            <div key={i} className="flex justify-start">
              <div className="flex flex-col gap-2 rounded-[20px] bg-[var(--fp-surface-2)] px-5 py-4">
                {block.lines.map((line) => (
                  <div key={line.k} className="flex items-baseline gap-2.5 text-[15px]">
                    <span className="text-[var(--fp-success)]">✓</span>
        ...
        if (block.kind === "computer") {
          return (
            <div
              key={i}
              className="w-[340px] rounded-[18px] border border-[var(--fp-hairline-strong)] bg-[var(--fp-hairline)] px-[18px] py-4"
            >
              <div className="flex items-center justify-between">
                <span className="text-[15px] font-medium text-[var(--fp-ink)]">
              ...
              <div className="my-2.5 text-[14.5px] leading-[1.5] text-[var(--fp-soft)]">
                <ChatMarkdown>{block.text}</ChatMarkdown>
              </div>
            </div>
          );
...
function ComputerModePicker({
  ...
  return (
    <div className="mt-4">
      <div className="text-[14px] text-[var(--fp-muted)]">
        <Trans>Computer</Trans>
      </div>
        ...
        {(["team", "dedicated"] as const).map((mode) => (
          <button
            ...
            className={`rounded-[11px] border px-3.5 py-3 text-[14px] capitalize ${
              value === mode
                ? "border-[var(--fp-muted-2)] bg-[var(--fp-surface-2)] text-[var(--fp-ink)]"
                : "border-[var(--fp-border)] text-[var(--fp-muted)]"
            }`}
          >
    ...
    <div>
      ...
      {error ? (
        <p
          ...
          className="mb-3 text-[13px] text-[var(--fp-danger)]"
        >
          {error}
        </p>
      ) : null}
      <label className="mt-6 block text-[14px] text-[var(--fp-muted)]">
        <Trans>Name</Trans>
        <input
          value={name}
          ...
          className="mt-2 w-full rounded-[11px] border border-[var(--fp-border)] bg-transparent px-3.5 py-3 text-[var(--fp-ink)]"
        />
      </label>
      <label className="mt-4 block text-[14px] text-[var(--fp-muted)]">
        <Trans>Title</Trans>
        <input
          value={title}
      ...
      <button
        ...
        className="mt-5 rounded-[11px] bg-[var(--fp-cream)] px-4 py-2 text-[var(--fp-cream-ink)] disabled:opacity-40"
      >
  ...
  return (
    <div data-testid="bot-settings">
      ...
      <details data-testid="bot-settings-advanced" className="group mt-5">
        <summary className="flex cursor-pointer list-none items-center justify-between gap-3 text-[14px] text-[var(--fp-muted)]">
        ...
        {memoryProviderConfigured ? (
          <div className="mt-4 text-[14px] text-[var(--fp-muted)]">
        ...
        <label className="mt-5 flex cursor-pointer items-center gap-3 text-[14px] text-[var(--fp-soft)]">
          <input
            type="checkbox"
            checked={autoSpeak}
      ...
      {error ? <p className="mt-2 text-[13px] text-[var(--fp-danger)]">{error}</p> : null}
      <div className="mt-5 flex flex-col items-start gap-3">
        <button
          ...
          className="rounded-[11px] bg-[var(--fp-cream)] px-4 py-2 text-[var(--fp-cream-ink)] disabled:opacity-40"
        >
          <Trans>Save</Trans>
        </button>
        <button
          ...
          className="text-[14px] text-[var(--fp-muted)]"
        >
          <Trans>Export</Trans>
        </button>
        <button type="button" onClick={onClear} className="text-[14px] text-[var(--fp-danger)]">
  ...
  return (
    ...
    >
      <BuiCard
        ...
        className="w-full max-w-[420px] border border-[var(--fp-elevated)] p-5"
        onPointerDown={(event) => event.stopPropagation()}
      >
        <div className="flex items-center gap-2.5">
          <Lock size={17} strokeWidth={1.8} className="text-[#A78BFA]" aria-hidden="true" />
          <h2 id="new-space-title" className="text-[17px] font-medium text-[var(--fp-ink-strong)]">
            <Trans>New space</Trans>
          </h2>
        </div>
        <label className="mt-4 block text-[13.5px] text-[var(--fp-soft)]">
          <Trans>Name</Trans>
          <input
            maxLength={60}
            value={name}
            ...
            className="mt-2 w-full rounded-[11px] border border-[var(--fp-elevated)] bg-[var(--fp-inset)] px-3.5 py-2.5 text-[14.5px] text-[var(--fp-ink)] outline-none focus:border-[#66666D]"
          />
        </label>
        {error ? <p className="mt-3 text-[13.5px] text-[var(--fp-danger)]">{error}</p> : null}
  ...
  return (
    ...
    >
      <form
        ...
        className="w-full max-w-[420px] rounded-[18px] border border-[var(--fp-elevated)] bg-[var(--fp-surface-2)] p-5 shadow-[0_24px_70px_rgba(0,0,0,.65)]"
        onPointerDown={(event) => event.stopPropagation()}
        onSubmit={(event) => {
          event.preventDefault();
          const trimmed = name.trim();
      ...
      >
        <h2
          ...
          className="text-[17px] font-medium text-[var(--fp-ink-strong)]"
        >
          <Trans>New section</Trans>
        </h2>
        <p className="mt-2 text-[14px] leading-6 text-[var(--fp-muted)]">
        ...
        <div className="mt-5 flex justify-end gap-2.5">
          <button
            ...
            disabled={saving}
            onClick={onCancel}
            className="rounded-[10px] px-3.5 py-2 text-[14px] text-[var(--fp-soft)] hover:bg-[var(--fp-scroll)] disabled:opacity-40"
          >
            <Trans>Cancel</Trans>
          </button>
          <button
            ...
            className="rounded-[10px] bg-[var(--fp-cream)] px-3.5 py-2 text-[14px] font-medium text-[var(--fp-cream-ink)] disabled:opacity-40"
          >
    ...
    >
      ...
      >
        ...
        <p
          ...
          className="mt-2 text-[14px] leading-6 text-[var(--fp-muted)]"
        >
          <Trans>
        ...
        <div className="mt-5 flex justify-end gap-2.5">
          ...
          <button
            ...
            className="rounded-[10px] bg-[var(--fp-danger-strong)] px-3.5 py-2 text-[14px] font-medium text-white disabled:opacity-40"
          >
  ...
  return (
    ...
    >
      <div
        ...
        onPointerDown={(event) => event.stopPropagation()}
      >
        <h2 id="delete-bot-title" className="text-[17px] font-medium text-[var(--fp-ink-strong)]">
        ...
        <fieldset className="mt-4 space-y-2">
          <legend className="mb-2 text-[13.5px] text-[var(--fp-soft)]">
            <Trans>What about its memories?</Trans>
          </legend>
          <label className="flex cursor-pointer gap-3 rounded-[11px] border border-[var(--fp-elevated)] p-3">
            <input
              type="radio"
              name="delete-memory"
            ...
            />
            <span>
              <span className="block text-[14px] text-[var(--fp-ink)]">
                <Trans>Keep memories</Trans>
              </span>
              <span className="mt-0.5 block text-[12.5px] text-[var(--fp-muted)]">
  ...
  return (
    ...
    >
      <div
        ...
        onPointerDown={(event) => event.stopPropagation()}
      >
        <h2 id="delete-item-title" className="text-[17px] font-medium text-[var(--fp-ink-strong)]">
...
function ChoiceCard({
  ...
  return (
    <div className="flex justify-start">
      <div className="w-[min(420px,80%)] rounded-[20px] border border-[var(--fp-border)] bg-[var(--fp-surface)] px-[18px] py-[14px]">
        <div className="text-[15.5px] text-[var(--fp-body)]">{block.question}</div>
        {block.subtitle ? (
          <div className="mt-0.5 text-[13px] text-[var(--fp-soft)]">{block.subtitle}</div>
        ) : null}
          ...
          {block.options
            ...
            .map((option) => (
              <button
                ...
                className={`flex w-full items-center gap-3 rounded-[12px] border border-[var(--fp-border)] px-3.5 py-3 text-start text-[var(--fp-ink)] disabled:opacity-60 ${block.answerId ? "bg-[var(--fp-elevated)]" : "bg-[var(--fp-surface-2)] hover:bg-[var(--fp-elevated)]"}`}
              >
                <span className="grid h-[24px] w-[24px] place-items-center rounded-[7px] bg-[var(--fp-elevated)] text-[12.5px] font-medium text-[var(--fp-soft)]">
                  {option.letter}
                </span>
                <span
                  className={`flex-1 text-[15px] ${block.answerId ? "text-[var(--fp-soft)]" : "text-[var(--fp-ink)]"}`}
                >
                  {option.label}
                </span>
                {block.answerId === option.id ? (
                  <span className="text-[var(--fp-soft)]">✓</span>
                ) : null}
              </button>
            ))}
        </div>
  ...
  async function authorize() {
    ...
    try {
      ...
      if (started.authorizationUrl) {
        window.open(started.authorizationUrl, "furlpay-bot-app-connect", "popup,width=560,height=720");
      }
...
function ChartCanvas({
  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        const { buildPlotParts } = await import("@furlpay-bot/core/plot");
  ...
  return (
    <div className="text-[var(--fp-soft)]">
      {meta.title ? (
        <div className="mb-1 text-[14.5px] font-semibold text-[var(--fp-ink)]">{meta.title}</div>
      ) : null}
...
function McpApprovalCard({
  ...
  return (
    <BuiCard className="max-w-[74%] p-4">
      ...
      {state === "dismissed" ? (
        <p className="mt-2 text-[13px] text-[var(--fp-muted)]">
...
function ChartBlockView({
  ...
  return (
    <>
      <div className="group relative max-w-[74%] rounded-[20px] bg-[var(--fp-hairline)] p-4">
        <ChartCanvas spec={spec} data={data} width={520} />
        <button
          type="button"
          onClick={() => setExpanded(true)}
          className="absolute end-3 top-3 rounded-lg border border-[var(--fp-elevated)] bg-[var(--fp-elevated)] px-2.5 py-1 text-[11px] text-[var(--fp-soft)] opacity-0 transition-opacity group-hover:opacity-100 focus-visible:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#A6A6AD]"
        >
          <Trans>Expand</Trans>
        </button>
      </div>
      {expanded ? (
        ...
        >
          <div className="max-h-[92vh] w-[min(1320px,94vw)] overflow-auto rounded-[24px] border border-[var(--fp-border)] bg-[var(--fp-surface)] p-8 shadow-[0_40px_90px_rgba(0,0,0,.6)]">
            <div className="mb-3 flex items-center justify-between">
              <span className="text-[13px] text-[var(--fp-muted)]">{name}</span>
              <button
                type="button"
                aria-label={t`Close chart`}
                onClick={() => setExpanded(false)}
                className="text-lg text-[var(--fp-muted)] hover:text-[var(--fp-body)]"
              >
                ✕
              </button>
            </div>
  ...
  return (
    <div ref={container}>
      {src ? (
        ...
        <div className="rounded-[20px] border border-[var(--fp-border)] bg-[var(--fp-hairline)] px-4 py-3 text-[14px] text-[var(--fp-muted)]">
          {name}
        </div>
      )}
      {open && src ? (
