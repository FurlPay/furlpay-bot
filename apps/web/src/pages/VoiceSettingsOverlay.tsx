...
import type { VoiceCatalogEntry, VoiceCredential, VoiceInfo, VoiceStatus } from "@furlpay-bot/contracts";
  ...
  return (
    <div className="absolute inset-0 z-30 flex items-center justify-center bg-[rgba(4,4,5,.62)] p-4 sm:p-10">
      <div
        ...
        className="flex h-[min(680px,100%)] w-[920px] max-w-full flex-col overflow-hidden rounded-[26px] border border-[var(--fp-hairline-strong)] bg-[var(--fp-surface)] shadow-[0_40px_90px_rgba(0,0,0,.55)]"
      >
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-6 overflow-hidden px-6 py-6 sm:px-8 md:flex-row">
          <div className="flex min-h-0 shrink-0 flex-col md:w-[280px]">
            ...
            <div className="rk-scroll overflow-y-auto rounded-[13px] border border-[var(--fp-border)]">
              {catalog.map((entry) => {
          ...
          <div className="rk-scroll min-h-0 min-w-0 flex-1 overflow-y-auto">
            ...
            {selected ? (
              <>
                <p className="text-[13.5px] leading-[1.5] text-[var(--fp-muted)]">
                ...
                <label className="mt-5 block text-[13.5px] text-[var(--fp-muted)]">
                  <Trans>API key</Trans>
                  <input
                    type="password"
                    ...
                    className="mt-2 w-full rounded-[11px] border border-[var(--fp-border)] bg-[var(--fp-inset)] px-3.5 py-2.5 text-[14px] text-[var(--fp-ink)] outline-none"
                  />
                </label>
                <Button
                  type="button"
                ...
                {credential ? (
                  <>
                    <label className="mt-6 block text-[13.5px] text-[var(--fp-muted)]">
                      <Trans>Voice</Trans>
                      <select
                        value={voiceId}
                    ...
                    <button
                      ...
                      className="mt-4 text-[14px] text-[var(--fp-soft)] disabled:opacity-40"
                    >
