...
export function PeerMessagesOverlay({
  ...
  return (
    <div
      ...
      tabIndex={-1}
      className="absolute inset-0 z-50 flex flex-col bg-[var(--fp-page)] outline-none"
    >
      <div className="flex items-center justify-between gap-4 border-b border-[var(--fp-hairline)] px-[18px] py-3.5">
        ...
        <button
          ...
          aria-label={t`Close`}
          onClick={onClose}
          className="rounded-[9px] px-3 py-1.5 text-[13.5px] text-[var(--fp-soft)] hover:bg-[var(--fp-elevated)] hover:text-[var(--fp-ink)]"
        >
          <Trans>Close</Trans>
        </button>
      </div>
      ...
      {!historyReady ? (
        <div className="grid flex-1 place-items-center px-8 text-center text-[13.5px] text-[var(--fp-muted-2)]">
          <Trans>Loading…</Trans>
        </div>
      ) : historyFailed ? (
        <div className="grid flex-1 place-items-center px-8 text-center text-[13.5px] text-[var(--fp-muted-2)]">
              ...
              >
                <div
                  className={`max-w-[80%] rounded-[16px] px-4 py-2.5 ${
                    sent ? "bg-[var(--fp-elevated)]" : "bg-[var(--fp-hairline)]"
                  }`}
                >
                  <div className="mb-1 text-[12px] text-[var(--fp-faint)]" dir="auto">
                    {sent ? botName : peerBotName}
                  </div>
                  <div className="text-[14.5px] leading-[1.5] text-[var(--fp-body)]" dir="auto">
      ...
      <div className="flex items-center justify-between gap-4 border-t border-[var(--fp-hairline)] px-[18px] py-3.5">
        <p className="text-[13.5px] text-[var(--fp-muted-2)]">
          <Trans>This chat is view-only</Trans>
        </p>
        <button
          type="button"
          onClick={onClose}
          className="rounded-[9px] border border-[var(--fp-scroll)] bg-[var(--fp-surface)] px-3.5 py-1.5 text-[13.5px] text-[var(--fp-ink)] hover:bg-[var(--fp-elevated)]"
        >
          <Trans>Close</Trans>
        </button>
      </div>
