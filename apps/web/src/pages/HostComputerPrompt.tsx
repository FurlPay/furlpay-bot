...
export function HostComputerPrompt({ initialMe }: { initialMe?: Me }) {
  ...
  return (
    <div className="absolute inset-0 z-40 grid place-items-center bg-[var(--fp-page)]/80 px-6">
      <div className="w-[440px] rounded-[20px] border border-[var(--fp-border)] bg-[var(--fp-inset)] p-6">
        <h2 className="text-[22px] font-medium text-[var(--fp-ink-strong)]">
        ...
        <div className="mt-5 flex flex-col gap-2">
          ...
          <button
            ...
            className="rounded-[11px] border border-[var(--fp-border)] px-5 py-2.5 text-[var(--fp-ink)] disabled:opacity-40"
          >
            <Trans>Use {hostLabel}</Trans>
          </button>
        </div>
        <p className="mt-3 text-[12px] leading-relaxed text-[var(--fp-muted-2)]">
          {mac ? (
            <Trans>
