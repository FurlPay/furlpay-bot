  ...
  return (
    <div className="space-y-2">
        ...
        <div key={index} className="flex items-start gap-2">
          ...
          {value.length > 1 ? (
            <button
              ...
              className="mt-3 shrink-0 text-[var(--fp-muted)] hover:text-[var(--fp-ink)]"
            >
              <svg
                width="15"
                height="15"
      ...
      <button
        ...
        className="text-[13.5px] text-[var(--fp-muted)] hover:text-[var(--fp-ink)]"
      >
...
export function RoutineSchedule({
  ...
  return (
    <div className="mt-2 rounded-[13px] border border-[var(--fp-border)] p-3">
      <div className="flex items-center gap-2.5 px-0.5">
        ...
        <span className="text-[14.5px] text-[var(--fp-ink)]">{lead}</span>
        {detail ? (
          <span className="flex-1 text-[14.5px] text-[var(--fp-muted)]">{detail}</span>
        ) : null}
      </div>
      <div className="mt-2.5 flex flex-wrap items-center gap-2 rounded-[11px] bg-[var(--fp-surface)] px-2.5 py-2.5 text-[14px] text-[var(--fp-faint)]">
        <select
          className="rk-schedule-select"
          value={value.freq}
        ...
        {value.freq === "Advanced" ? (
          <input
            ...
            className="min-w-[120px] flex-1 rounded-lg border-0 bg-[var(--fp-scroll)] px-2.5 py-1.5 font-mono text-[13.5px] text-[var(--fp-ink)] outline-none"
          />
        ) : null}
      </div>
    </div>
