import type { ModelOAuthBegin } from "@furlpay-bot/contracts";
import { cancelModelOAuthAttempt, finishModelOAuthAttempt } from "@furlpay-bot/core";
...
export function useModelOAuthSignIn(options: {
  ...
  async function startSubscriptionSignIn(begin: ModelOAuthSignInBegin) {
    ...
    try {
      ...
      window.open(started.verificationUri, "furlpay-bot-model-oauth", "noopener,noreferrer");
