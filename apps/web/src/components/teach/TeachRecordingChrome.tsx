...
import type { TaughtSkill } from "@furlpay-bot/contracts";
...
export function TeachRecordingChrome({
  ...
  if (variant === "overlay") {
    return (
      ...
      >
        <div className="truncate text-[13px] text-[var(--fp-ink)]">
          <Trans>Recording: {recording.goal}</Trans>
        </div>
        <div className="text-[12px] text-[var(--fp-muted)]">
  ...
  return (
    <div
      ...
      className="rounded-[11px] border border-[var(--fp-hairline-strong)] bg-[var(--fp-inset)] px-3 py-3"
    >
      <div className="text-[14px] text-[var(--fp-ink)]">
        <Trans>Recording: {recording.goal}</Trans>
      </div>
