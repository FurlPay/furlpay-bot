import { BotAvatar, GroupAvatar, type GroupAvatarMember } from "@furlpay-bot/ui-web";
  ...
  return (
    <div className="flex justify-start">
      <button
        ...
        onClick={onClick}
        className="inline-flex max-w-full items-center gap-1.5 rounded-full px-2.5 py-1 text-[13px] text-[var(--fp-muted)] transition-colors hover:bg-[var(--fp-inset)] hover:text-[#B8B8BD]"
      >
