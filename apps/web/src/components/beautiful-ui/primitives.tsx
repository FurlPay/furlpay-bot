...
export function BuiButton({
  ...
  return (
    <button
      ...
      className={
        tone === "accent"
          ? "rounded-full bg-[var(--fp-cream)] px-4 py-2 text-[13.5px] font-medium text-[var(--fp-cream-ink)] transition-colors duration-150 disabled:cursor-not-allowed disabled:opacity-100"
