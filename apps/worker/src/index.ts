import type { JobPublisher, JobWorkerHost } from "@furlpay-bot/adapter-kit";
...
import { resolveEncryptionKey, resolveSupervisorToken } from "@furlpay-bot/core";
import { createDb, createThreadEvents } from "@furlpay-bot/db";
...
async function main() {
  ...
  console.log("furlpay-bot worker ready");
}
