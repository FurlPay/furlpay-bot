...
const HOME_COPY: Record<Locale, HomeCopy> = {
  en: {
    title: "FurlPay Bot | Open source Grok Bot alternative",
    description: SITE_DESCRIPTION,
    ogImageAlt:
      "FurlPay Bot — AI teammates you actually own. Your keys, your model, your machine.",
    ...
    hero: {
      ...
      lead: "FurlPay Bot is an open source Grok Bot alternative. Give a bot real work. It signs in to your tools, uses them the way you do, and comes back when it needs you.",
    ...
    selfHost: {
      ...
      copy: "Run FurlPay Bot on your machine. Your keys, your model, your data.",
      features: [
        {
    ...
    openSource: {
      ...
      copy: "FurlPay Bot is Apache-2.0 licensed and runs on your own machine with your own model keys. Nothing is gated, nothing phones home.",
    ...
    cta: {
      ...
      copy: "Give FurlPay Bot something you have been putting off and let it handle the follow-through.",
      getStarted: "Get started",
      viewOnGithub: "View on GitHub",
    ...
    getStartedDialog: {
      ...
      cloudHint: "Hosted FurlPay Bot is coming. Leave your email.",
      back: "Back",
      successTitle: "You're in.",
      successCopy:
        "We'll email you when hosted FurlPay Bot is ready. Want to start today? Jump to Self-host on this page.",
      done: "Done",
      viewOnGithub: "View on GitHub",
    },
    waitlist: {
  ...
  de: {
    title: "FurlPay Bot | Open-Source-Alternative zu Grok Bot",
    description:
      "FurlPay Bot ist eine Open-Source-Alternative zu Grok Bot für persistente KI-Teamkollegen, die echte Arbeit erledigen. Deine Keys, dein Modell, deine Maschine.",
    ogImageAlt:
      "FurlPay Bot — KI-Teamkollegen, die dir wirklich gehören. Deine Keys, dein Modell, deine Maschine.",
    ...
    hero: {
      ...
      lead: "FurlPay Bot ist eine Open-Source-Alternative zu Grok Bot. Gib einem Bot echte Arbeit. Er meldet sich in deinen Tools an, nutzt sie wie du — und kommt zurück, wenn er dich braucht.",
      getStarted: "Loslegen",
      viewOnGithub: "Auf GitHub ansehen",
    ...
    selfHost: {
      ...
      copy: "Betreibe FurlPay Bot auf deiner Maschine. Deine Keys, dein Modell, deine Daten.",
      features: [
        {
    ...
    openSource: {
      ...
      copy: "FurlPay Bot ist Apache-2.0-lizenziert und läuft auf deiner Maschine mit deinen Model-Keys. Nichts ist freigeschaltet, nichts telefoniert nach Hause.",
      selfHostTitle: "Self-host",
    ...
    cta: {
      ...
      copy: "Gib FurlPay Bot etwas, das du aufgeschoben hast — und lass es den Follow-through übernehmen.",
      getStarted: "Loslegen",
      viewOnGithub: "Auf GitHub ansehen",
      openSourceValue: "Open Source",
      selfHostValue: "Self-host",
    ...
    getStartedDialog: {
      ...
      cloudHint: "Gehostetes FurlPay Bot kommt. Hinterlasse deine E-Mail.",
      back: "Zurück",
      successTitle: "Du bist dabei.",
      successCopy:
        "Wir mailen dir, wenn gehostetes FurlPay Bot bereit ist. Heute starten? Zum Self-host-Abschnitt auf dieser Seite.",
      done: "Fertig",
      viewOnGithub: "Auf GitHub ansehen",
    },
    waitlist: {
  ...
  ko: {
    title: "FurlPay Bot | 오픈소스 Grok Bot 대안",
    description:
      "FurlPay Bot는 실제 업무를 수행하는 지속형 AI 팀원을 위한 오픈소스 Grok Bot 대안입니다. 키, 모델, 머신 — 모두 당신 것.",
    ogImageAlt: "FurlPay Bot — 진짜로 내 것인 AI 팀원. 키, 모델, 머신 — 모두 당신 것.",
    ...
    hero: {
      ...
      lead: "FurlPay Bot는 오픈소스 Grok Bot 대안입니다. 봇에게 실제 업무를 맡기세요. 봇이 도구에 로그인하고, 당신처럼 사용하며, 필요할 때 돌아와 묻습니다.",
      getStarted: "시작하기",
      viewOnGithub: "GitHub에서 보기",
    ...
    selfHost: {
      eyebrow: "셀프 호스트",
      heading: "컴퓨터는 당신 것",
      copy: "당신 머신에서 FurlPay Bot를 실행하세요. 키, 모델, 데이터는 모두 당신 것.",
      features: [
        {
    ...
    openSource: {
      ...
      copy: "FurlPay Bot는 Apache-2.0 라이선스이며, 당신 머신에서 당신 모델 키로 실행됩니다. 잠긴 기능도, 외부로 연락하는 것도 없습니다.",
    ...
    cta: {
      heading: "첫 봇을 만나보세요",
      copy: "미뤄 두었던 일을 FurlPay Bot에 맡기고, 후속까지 맡기세요.",
      getStarted: "시작하기",
      viewOnGithub: "GitHub에서 보기",
    ...
    getStartedDialog: {
      ...
      cloudHint: "호스팅 FurlPay Bot가 곧 옵니다. 이메일을 남겨 주세요.",
      back: "뒤로",
      successTitle: "등록되었습니다.",
      successCopy:
        "호스팅 FurlPay Bot가 준비되면 메일로 알려 드립니다. 오늘 시작하려면 이 페이지의 셀프 호스트 섹션으로 이동하세요.",
      done: "완료",
      viewOnGithub: "GitHub에서 보기",
    },
    waitlist: {
