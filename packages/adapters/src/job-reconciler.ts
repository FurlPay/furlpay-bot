...
import type { Pool, PrismaClient, ThreadEvents } from "@furlpay-bot/db";
...
// Two keys give FurlPay Bot's lock a namespace without relying on a hash that might collide
