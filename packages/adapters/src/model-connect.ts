import type { ModelConnectInput, ModelCredential } from "@furlpay-bot/contracts";
import { OPENAI_COMPATIBLE_PROVIDER_ID as CONTRACT_OPENAI_COMPAT } from "@furlpay-bot/contracts";
