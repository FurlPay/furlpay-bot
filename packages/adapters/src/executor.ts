...
import type { MessageBlock, RunStatus } from "@furlpay-bot/contracts";
import { ATTACHMENT_MAX_BYTES, isAttachmentImageMimeType } from "@furlpay-bot/contracts";
import {
...
import { approvalEffectKey } from "@furlpay-bot/core/node/approval-effect-key";
import {
...
const STATIC_SHELL_EXPANSIONS: Readonly<Record<string, string>> = {
  ...
  PWD: "/home/furlpay-bot",
  TMPDIR: "/tmp",
  USER: "furlpay-bot",
  WORKSPACE: "/home/furlpay-bot/workspace",
  XDG_CONFIG_HOME: "/home/furlpay-bot/.config",
};
...
const CATALOG_APPROVAL_TOOL = "__furlpayBotCatalogTool";
...
export function buildApprovalContinuation(
  ...
  return [
    "FurlPay Bot is resuming after the user approved the exact tool request(s) below.",
...
export async function loadCurrentTurnImages(
  ...
  const images: NonNullable<import("@furlpay-bot/adapter-kit").AgentRunRequest["currentTurnImages"]> =
    [];
