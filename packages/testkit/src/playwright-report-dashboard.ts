...
<head>
  ...
  <title>Playwright · FurlPay Bot</title>
  <style>
    ${SHARED_PAGE_STYLES}
...
<body>
  <main>
    <header>
      <div>
        <p class="eyebrow">FurlPay Bot · browser checks</p>
        <h1>Playwright</h1>
      ...
      <div class="actions">
        ...
        <a class="button" href="https://github.com/FurlPay/furlpay-bot/actions">GitHub Actions</a>
      </div>
    </header>
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <meta name="color-scheme" content="dark" />
  <title>Run screenshots · FurlPay Bot</title>
  <style>
    ${SHARED_PAGE_STYLES}
...
<body>
  <main>
    <header>
      <div>
        <p class="eyebrow">FurlPay Bot · visual review</p>
  ...
  <script>
    ...
    const storageKey = "furlpay-bot-playwright-gallery-columns";
