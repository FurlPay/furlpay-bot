import type { TransactionalEmail, TransactionalEmailProvider } from "@furlpay-bot/adapter-kit";
import { emailAllowed, parseAllowlist, signupPolicyFromEnv } from "@furlpay-bot/core";
import { bootstrapUserSpace, type PrismaClient } from "@furlpay-bot/db";
...
export function passwordResetEmail(
  ...
  return {
    to: user.email,
    subject: "Reset your FurlPay Bot password",
    text: [
      `Hi ${name},`,
      "",
      "Reset your FurlPay Bot password using this link:",
      resetUrl,
      "",
      "This link expires in one hour. If you did not request this, you can ignore this email.",
    ].join("\n"),
    html: `<p>Hi ${safeName},</p><p>Reset your FurlPay Bot password:</p><p><a href="${safeUrl}">Reset password</a></p><p>This link expires in one hour. If you did not request this, you can ignore this email.</p>`,
  };
}
