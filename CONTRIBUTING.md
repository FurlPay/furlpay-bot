# Contributing to FurlPay Bot

Thanks for helping improve FurlPay Bot. Keep changes focused and testable.
...
| Address | Use for |
| --- | --- |
| [security@bot.furlpay.com](mailto:security@bot.furlpay.com) | Vulnerabilities only — see [SECURITY.md](SECURITY.md) |
| [support@bot.furlpay.com](mailto:support@bot.furlpay.com) | User and support questions |
| [elie@bot.furlpay.com](mailto:elie@bot.furlpay.com) | Maintainer |
