...
Email **security@bot.furlpay.com** only. Do not open public GitHub issues for security bugs.
...
- General support: **support@bot.furlpay.com**
- Maintainer: **elie@bot.furlpay.com**

## Scope

This policy covers the FurlPay Bot self-hosted product in **this repository**.
